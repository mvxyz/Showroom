...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ТипыЦенНоменклатуры";
	ВидДоступа.Представление = НСтр("ru = 'Типы цен номенклатуры'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.ТипыЦенНоменклатуры");
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.Заказ, Истина);
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Профиль "Мобильный менеджер".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "2d4f8cc0-5dff-11e9-b487-c0b6f9682634";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Мобильный менеджер'", Метаданные.ОсновнойЯзык.КодЯзыка);
	ОписаниеПрофиля.Описание = НСтр("ru = 'Предоставляет права для работы в приложении Визард:Выставочный зал'");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ЗапускМобильногоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	ОписаниеПрофиля.Роли.Добавить("МобильныйМенеджер");
	...
	ОписаниеПрофиля.ВидыДоступа.Добавить("ТипыЦенНоменклатуры", "ВначалеВсеРазрешены");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
	...
	ИначеЕсли ВидДоступа = "ТипыЦенНоменклатуры" Тогда
		Использование = Истина;
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	Описание = Описание + "
	|Документ.Заказ.Чтение.Организации
	|Документ.Заказ.Чтение.Пользователи
	|Документ.Заказ.Изменение.Организации
	|Документ.Заказ.Изменение.Пользователи
	...
	|Справочник.ТипыЦенНоменклатуры.Чтение.ТипыЦенНоменклатуры
	|Документ.Заказ.Чтение.ТипыЦенНоменклатуры
	|РегистрСведений.ЦеныНоменклатуры.Чтение.ТипыЦенНоменклатуры	
	|";
